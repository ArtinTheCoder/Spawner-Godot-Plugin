...
@export var max_active_enemies : int = 35  # Maximum number of active enemies before pausing
...
func _physics_process(delta):
	...
	# Only try spawning if below the max allowed active enemies
...
func _on_enemy_died(enemy):
	...
	# Continues to spawn the next enemy 
